...
validation=nogoal %>% filter(saison<102)
nogoal_app=nogoal %>% filter(saison==102)
nogoal_sans_val=nogoal_app[-c(1:71),]
...
test=rbind(test,nogoal_app[c(1:71), ],validation)
nogoal_train= train %>%
...
prediction <- test.predict$class$max.dist[,tune.splsda$choice.ncomp$ncomp] 
